...
const TicketSelection = ({ onNext }) => {
  ...
  return (
    <div className=" main-container max-w-lg mx-auto p-6 shadow-md rounded">
      ...
      <p className="text-white text-center w-3xs m- ">Join us for an unforgettable experience at Techember Fest! Secure your spot now.</p>
      </div>
      <p className="flex justify-center items-center text-center text-sm text-white"><span><MapPin className="text-red-500" /></span>TinoHub, Lagos, Nigeria || December 10, 2025 | 7:00PM</p>
      </div>
      ...
      <div className="ticket-selections">
        ...
        <div className="mt-2 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3   gap-3 h-20 justify-center items-center ">
          {[
            ...
            { type: "VVIP", price: "$250", access: "VVIP ACCESS" },
      ...
      <div className="ticket-quality  mt-4 sm:mt-24 ">
        ...
        <input
          type="number"
          min="1"
          className="number-select w-full mt-2 p-2 border rounded text-white"
          value={quantity}
      ...
      <div className="navigation-div-btn mt-6 flex justify-between">
        ...
        <button className="next-btn bg-blue-500 text-white px-4 py-2 " onClick={handleNext}>
          Next
        </button>
      </div>
    </div>
